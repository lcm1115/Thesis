...
\begin{center}
    ...
    \vspace{3em}
    {\LARGE \blackout{Liam Morris}} \\
    {\tt \blackout{lcm1115@rit.edu}} \\
    \vspace{3em}
    \begin{adjustwidth}{.5in}{.5in}
        Chair: \blackout{Professor Stanis{\l}aw Radziszowski} \hfill {\tt \blackout{spr@cs.rit.edu}} \\
        \vspace{2em}
        \hrulefill \\
        \vspace{3em}
        Reader: \blackout{Professor Warren Carithers} \hfill {\tt \blackout{wrc@cs.rit.edu}} \\
        \vspace{2em}
        \hrulefill \\
        \vspace{3em} Observer: \blackout{Professor Bo Yuan} \hfill {\tt \blackout{bo.yuan@rit.edu}} \\
        \vspace{2em}
        \hrulefill
    \end{adjustwidth}
